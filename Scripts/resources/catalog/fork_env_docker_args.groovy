// This script must have a single parameter defining the container name
...
if (args.length != 1 || args[0].isEmpty()) {
    throw new IllegalArgumentException("This script requires a container name as parameter")
}
